CREATE OR REPLACE PROCEDURE MAG80DAT.CREATE_DISPLAY_JOURNAL_TABLE_VIEW  ( IN MYTABLE_LIBRARY   varchar(100),
...
LANGUAGE SQL
SPECIFIC MAG80DAT.YCRTJRNVIW
SET OPTION DBGVIEW=*SOURCE
P1: BEGIN

DECLARE MYCMD varchar(32000);
...
SET STRINGPOSITION=1; 
   ...
   CLOSE cursor1;
   SET MYCMD= TRIM(MYCMD) CONCAT
   ' FROM TABLE(QSYS2.DISPLAY_JOURNAL(' CONCAT
